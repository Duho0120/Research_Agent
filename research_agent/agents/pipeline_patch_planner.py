...
def prepare_patch_plan(competition: str, source_trial_id: str, next_trial_id: str) -> dict[str, Any]:
    ...
    plan = {
        ...
        "validation_commands": [
            f"python -B -m research_agent.cli validate-config --competition {competition} --trial {next_trial_id}",
...
def _apply_pipeline_axis(
    ...
    if axis == "augmentation":
        ...
        _append_unique(target_files, "research_agent/pipeline/augmentation.py")
        ...
        _append_unique(target_files, "research_agent/pipeline/dataset.py")
        ...
        _append_unique(target_files, "research_agent/pipeline/losses.py")
        _append_unique(target_files, "research_agent/pipeline/post_processing.py")
        ...
        _append_unique(target_files, "research_agent/pipeline/model_adapter.py")
